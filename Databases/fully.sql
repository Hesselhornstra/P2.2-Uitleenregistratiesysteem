...
CREATE TABLE IF NOT EXISTS `artikelen` (
  ...
  PRIMARY KEY (`id`),
  KEY `cate` (`cate`),
  CONSTRAINT `cate` FOREIGN KEY (`cate`) REFERENCES `categorieen` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4;

-- Dumpen data van tabel uitleensysteem.artikelen: ~52 rows (ongeveer)
INSERT INTO `artikelen` (`id`, `naam`, `info`, `img`, `barcode`, `cate`) VALUES
	...
	(55, 'camera 5', 'info', 'https://media.s-bol.com/BBB50GjWX37Q/550x521.jpg', '50', 5),
	(56, 'pringles', 'congrats! you found a easter egg!', 'https://static-images.jumbo.com/product_images/211120221436_472570STK-1_360x360_2.png', '5053990161669', 0);
