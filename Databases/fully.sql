...
CREATE TABLE IF NOT EXISTS `artikelen` (
  ...
  PRIMARY KEY (`id`),
  KEY `cate` (`cate`),
  CONSTRAINT `categorie` FOREIGN KEY (`cate`) REFERENCES `categorieen` (`id`)
...
INSERT INTO `artikelen` (`id`, `naam`, `info`, `img`, `barcode`, `cate`) VALUES
	...
	(34, 'pringles', 'congrats! you found a easter egg!', 'https://static-images.jumbo.com/product_images/211120221436_472570STK-1_360x360_2.png', '5053990161669', '0'),
...
-- Dumpen data van tabel uitleensysteem.artikelges: ~5 rows (ongeveer)
...
-- Dumpen data van tabel uitleensysteem.users: ~4 rows (ongeveer)
